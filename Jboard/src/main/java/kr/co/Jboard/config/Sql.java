...
public class Sql {
	...
	public static final String UPDATE_ARTICLE_INC = "UPDATE `JBOARD_ARTICLE` SET `seq' = `seq` + 1 WHERE `seq` = ?;";
	public static final String UPDATE_ARTICLE_DEC = "UPDATE `JBOARD_ARTICLE` SET `seq` = `seq` - 1 WHERE `seq` = ?;";
