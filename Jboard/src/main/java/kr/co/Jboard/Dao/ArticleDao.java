...
public class ArticleDao {
	...
	public List<ArticleBean> selectComments (String parent) throws Exception{
		...
		public void updateArticleInc(String seq) throws Exception{
			//1~2단계
			Connection conn = DBConfig.getIncetence().getConnection();
			//3단계 
			PreparedStatement psmt = conn.prepareStatement(Sql.UPDATE_ARTICLE_INC);
			psmt.setString(1, seq);
			//4단계
			psmt.executeUpdate();
			//5단계 
		...
		public void updateArticleDec(String seq) throws Exception{
			//1~2단계
			Connection conn = DBConfig.getIncetence().getConnection();
			//3단계 
			PreparedStatement psmt = conn.prepareStatement(Sql.UPDATE_ARTICLE_DEC);
			psmt.setString(1, seq);
			//4단계
			psmt.executeUpdate();
			//5단계 
