...
<body>
	...
	response 내장객체
	-Client에서 Server로 요청ㅇ한 처리 결과를 응답해주는 응답객체
	Server에서 Client로 전달되는 객체 
	
	redirect(response 객체의 기능) 
	-Server에서 Client로 다시 요청(request) 명령하는 response의 기능 
	최종 요청에 대한 주소가 반영 
	
	forward(pageContext 객체 기능)
	서버 시스템 내에서 페이지 요청을 처리하는 pageContext 기능
	최초 요청에 대한 주소가 반영
